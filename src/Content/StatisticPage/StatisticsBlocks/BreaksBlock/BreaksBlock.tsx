...
import styles from './breaksblock.module.css';
var classNames = require('classnames');
interface IBreaksBlock {
  breaks: number,
}
export function BreaksBlock({breaks}: IBreaksBlock) {
  return (
    <div className={classNames(styles.breaksBlock, breaks > 0 ? styles.activeBreaks : styles.none)}>
      <h2 className={styles.breaksTitle}>Остановки</h2>
      <span className={styles.breaksValue}>{breaks}</span>
